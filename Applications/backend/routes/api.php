...
use App\Http\Controllers\front\SizeController as FrontSizeController;
...
Route::get('sizes', [FrontSizeController::class, 'index']);
...
Route::group(['middleware' => 'auth:sanctum', 'checkCustomerRole'], function () {
    ...
    Route::post('get-payment-details', [OrderController::class, 'createPaymentIntent']);
});
...
Route::group(['middleware' => 'auth:sanctum', 'checkAdminRole'], function () {
    ...
    Route::get('shipping-charges', [ShippingController::class, 'getShipping']);
    Route::post('save-shipping-charge', [ShippingController::class, 'updateShipping']);
});
